...
class NoticesControllerTest < ActionController::TestCase
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post :create, notice: { description: @notice.description, titile: @notice.titile, user_id: @notice.user_id }
    end
  ...
  test "should update notice" do
    patch :update, id: @notice, notice: { description: @notice.description, titile: @notice.titile, user_id: @notice.user_id }
    assert_redirected_to notice_path(assigns(:notice))
  end
